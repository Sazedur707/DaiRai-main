...
<body>
    <div style="text-align: center; " class="title">
        ...
        animation: vibrate-1 0.3s linear infinite both; display: block;">Live Chat</h2>
    </div>
...
if ($result) {
    ...
    ?>
            ...
            <form style="display: block;" class="mt-2" action="send_message.php" method="post">
            ...
            </form><form style="display: block;" action="live-chat.php" method="post"><input style="width: 100px; padding: 8px; margin: 4px 0px; background-color: grey; color: white; cursor: pointer; border-radius: 10px; margin-left: 3px;" type="submit" name="lastMessageBtn" value="Last Message"></form>

<?php
if (isset($_POST['lastMessageBtn'])) {
