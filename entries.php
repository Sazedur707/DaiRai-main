...
.button-88 {
  ...
  color: white;
  background: #ad5389;
  background: linear-gradient(0deg, blue 0%, rgb(138, 138, 255) 100%);
  border: none;
  box-shadow: 0 0.7em 1.5em -0.5em rgb(142, 142, 255);
...
.button-88:hover {
  box-shadow: 0 0.5em 1.5em -0.5em lightblue;
  color: black;
}

.button-88:active {
  box-shadow: 0 0.3em 1em -0.5em lightblue;
}
    .fixed-container {
        position: fixed;
        top: 0;
...
if ($result) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo '<div class="entry-id">' .'Entry No.'. $id . '</div>';
